  ...
  config = merge(
    ...
    },
    {
      ...
      for k, v in data.terraform_remote_state.network-vpcs : v.outputs.vpc_id => {
        ...
        route_to                          = null
        route_to_cidr_blocks              = null
        transit_gateway_vpc_attachment_id = module.transit_gateway_vpc_attachments_and_subnet_routes_network.transit_gateway_vpc_attachment_ids[k]
        static_routes                     = []
      }
    }
  )
...
module "transit_gateway_vpc_attachments_and_subnet_routes_network" {
