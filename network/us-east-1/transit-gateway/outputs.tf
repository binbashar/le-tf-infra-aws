...
output "tgw_inspection_route_table_id" {
  ...
  value       = var.enable_tgw && var.enable_network_firewall && lookup(var.enable_vpc_attach, "network", false) ? module.tgw_inspection_route_table[0].transit_gateway_route_table_id : null
}
