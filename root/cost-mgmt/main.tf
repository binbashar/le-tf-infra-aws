...
//  aws_sns_topic_arn         = "${data.terraform_remote_state.notifications.sns_topic_arn_bb_monitoring}"
//  tags                      = "${local.tags}"
//}
//# Billing = U$S100
...
module "aws_cost_mgmt_budget_notif_75" {
  source = "github.com/binbashar/terraform-aws-cost-budget.git?ref=v0.0.7"
