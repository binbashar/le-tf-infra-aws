...
!!! tip "User Management Definitions ![aws-service](../../images/icons/aws-emojipack/General_AWScloud.png){: style="width:30px"} ![aws-service](../../images/icons/aws-emojipack/SecurityIdentityCompliance_IAM.png){: style="width:15px"}" 
...
![leverage-aws-iam](../../images/diagrams/aws-iam.png "Leverage"){: style="width:600px"}
