...
import {
  ...
  id = "arn:aws:iam::ACCOUNT_ID:policy/bb-apps-devstg-terraform-backend-bucket-replication"
}

import {
  to = module.base_tf_backend["apps-devstg"].aws_iam_policy_attachment.bucket_replication[0]
  id = "bb-apps-devstg-terraform-backend-role-policy-attachment"
}
...
import {
  ...
  id = "arn:aws:iam::ACCOUNT_ID:policy/bb-apps-prd-terraform-backend-bucket-replication"
}

import {
  to = module.base_tf_backend["apps-prd"].aws_iam_policy_attachment.bucket_replication[0]
  id = "bb-apps-prd-terraform-backend-role-policy-attachment"
}
...
import {
  ...
  id = "arn:aws:iam::ACCOUNT_ID:policy/bb-data-science-terraform-backend-bucket-replication"
}
...
import {
  ...
  id = "bb-management-terraform-backend"
}
...
import {
  ...
  id = "bb-management-terraform-backend-replica"
}
...
import {
  ...
  id = "bb-management-terraform-backend-bucket-replication"
}

import {
  to = module.base_tf_backend["management"].aws_iam_policy.bucket_replication[0]
  id = "arn:aws:iam::ACCOUNT_ID:policy/bb-management-terraform-backend-bucket-replication"
}

import {
  to = module.base_tf_backend["management"].aws_iam_policy_attachment.bucket_replication[0]
  id = "bb-management-terraform-backend-role-policy-attachment"
}
...
import {
  ...
  id = "arn:aws:iam::ACCOUNT_ID:policy/bb-network-terraform-backend-bucket-replication"
}
...
import {
  ...
  id = "arn:aws:iam::ACCOUNT_ID:policy/bb-security-terraform-backend-bucket-replication"
}
...
import {
  to = module.base_tf_backend["security"].aws_s3_bucket_replication_configuration.this[0]
  id = "bb-security-terraform-backend"
}
...
import {
  ...
  id = "bb-shared-terraform-backend-bucket-replication"
}

import {
  to = module.base_tf_backend["shared"].aws_iam_policy.bucket_replication[0]
  id = "arn:aws:iam::ACCOUNT_ID:policy/bb-shared-terraform-backend-bucket-replication"
}

import {
  to = module.base_tf_backend["shared"].aws_iam_policy_attachment.bucket_replication[0]
  id = "bb-shared-terraform-backend-role-policy-attachment"
}
