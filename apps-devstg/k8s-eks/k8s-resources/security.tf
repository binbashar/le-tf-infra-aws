...
#   values = [
#     file("chart-values/cert-manager.yaml")
#   ]
...
#   values = [
#     file("chart-values/clusterissuer-binbash.yaml")
#   ]
...
#   values = [
#     file("chart-values/vault.yaml")
#   ]

#   depends_on = [ helm_release.external_dns_private, helm_release.cert_manager ]
# }
