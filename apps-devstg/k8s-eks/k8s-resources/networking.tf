...
#   values = [
#     file("chart-values/ingress-nginx-private.yaml")
#   ]
# }
...
#   values = [
#     file("chart-values/ingress-nginx-public.yaml")
#   ]
# }
...
#   values = [
#     file("chart-values/external-dns-private.yaml")
#   ]
...
#   values = [
#     file("chart-values/external-dns-public.yaml")
#   ]
