...
output "user_angelo_fenoglio_name" {
  ...
  value       = module.user_angelo_fenoglio.this_iam_user_name
}

/*output "user_angelo_fenoglio_login_profile_encrypted_password" {
  description = "The encrypted password, base64 encoded"
  value       = module.user_angelo_fenoglio.this_iam_user_login_profile_encrypted_password
  sensitive   = true
}*/
...
output "user_luis_gallardo_name" {
  description = "The user's name"
  value       = module.user_luis_gallardo.this_iam_user_name
}

/*output "user_luis_gallardo_login_profile_encrypted_password" {
  description = "The encrypted password, base64 encoded"
  value       = module.user_luis_gallardo.this_iam_user_login_profile_encrypted_password
  sensitive   = true
}*/
