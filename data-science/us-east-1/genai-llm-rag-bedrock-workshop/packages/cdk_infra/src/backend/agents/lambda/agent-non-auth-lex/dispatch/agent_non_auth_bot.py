...
from . import agent_non_auth as agent_enabled_bot
import os
...
class LexV2AgentNonAuthBotDispatcher:
    ...
    def dispatch_intent(self):
        non_auth_chat_bot = agent_enabled_bot.AgentEnabledBot(os.environ['AGENT_ID'], os.environ['AGENT_ALIAS'])

        agent_chat_bot_response = non_auth_chat_bot.ask(self.session_id, self.input_transcript)
        self.message = {
