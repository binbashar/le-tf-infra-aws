...
<<<<<<< HEAD
  ...
  aws_s3_bucket_1_enabled                       = "${var.aws_s3_bucket_1_enabled}"
  aws_s3_bucket_name_1                          = "${var.aws_s3_bucket_name_1}"
  aws_s3_bucket_2_enabled                       = "${var.aws_s3_bucket_2_enabled}"
  ...
  letsencrypt_dns_record_name_enabled           = "${var.letsencrypt_dns_record_name_enabled}"
  letsencrypt_dns_record_name                   = "${var.letsencrypt_dns_record_name}"
  letsencrypt_dns_record_value                  = "${var.letsencrypt_dns_record_value}"
  tags                                          = "${local.tags}"
=======
  source = "git::git@github.com:binbashar/bb-devops-tf-modules.git//aws/ec2-jenkins-bb?ref=v0.6"
